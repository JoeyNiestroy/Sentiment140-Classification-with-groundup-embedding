...
#scp Labeled_Data.csv jrniestroy@tempest.sciclone.wm.edu:/sciclone/data10/jrniestroy : File transfer PC to HCP
#scp -r jrniestroy@tempest.sciclone.wm.edu:/sciclone/data10/jrniestroy/outputs File Transfer HCP to PC
